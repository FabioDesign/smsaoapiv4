...
return [
    ...
    */
    ...
    'array' => "L'attribut doit contenir moins de :value éléments.",
    ],
    'lte' => [
    'numeric' => "L'attribut doit être inférieur ou égal à :value.",
    'file' => "L'attribut doit contenir moins de :value kilo-octets.",
    'string' => "L'attribut doit contenir moins de :value caractères.",
    'array' => "L'attribut ne doit pas contenir plus de :value éléments.",
    ],
    'max' => [
    ...
    'min' => [
    'numeric' => "L'attribute doit contenir au moins :min.",
    'file' => "L'attribute doit contenir au moins :min kilo-octets.",
    ...
    'file' => "L'attribut doit être de :size kilo-octets.",
    'string' => "L'attribut doit être de :size caractères.",
    'array' => "L'attribut doit contenir :size éléments.",
    ],
